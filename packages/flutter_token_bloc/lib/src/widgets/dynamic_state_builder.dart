...
///
/// The [builder] is called every time of any [TokenState] from
/// [tokenStateManager] changes. The data param is the last emitted state.
/// {@endtemplate}
class DynamicStateBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: Rx.merge(
        tokenStateManager.subjects.whereType<TokenState<dynamic>>(),
      ),
